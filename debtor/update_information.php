									...
									<div class="offset-xxl-2 col-xxl-8">
										...
										<form action="debtor/update_location.php" method="post" id="kt_form" enctype="multipart/form-data">
											<div class="form-group">
												...
												<input type="text" class="form-control form-control-solid form-control-lg" name="lname" value="<?= isset($_GET['e']) ? $_GET['lname'] : $_SESSION['lastname'] ?>" />
											</div>
											<div class="form-group">
												<label>First Name</label> <span class="text-danger">*</span>
												<input type="text" class="form-control form-control-solid form-control-lg" name="fname" value="<?= isset($_GET['e']) ? $_GET['fname'] : $_SESSION['firstname'] ?>" />
											</div>
											<div class="form-group">
												<label>Middle Name</label> <span class="text-danger">*</span>
												<input type="text" class="form-control form-control-solid form-control-lg" name="mname" value="<?= isset($_GET['e']) ? $_GET['mname'] : $_SESSION['middlename'] ?>" />
											</div>
											<div class="row">
												<div class="col-xl-6">
													<div class="form-group">
														...
														<span class="opacity-50">Select gender</span>
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-xl-6">
													<div class="form-group">
														...
														<input type="text" class="form-control form-control-solid form-control-lg" value="<?= $_SESSION['email'] ?>" disabled />
													</div>
												</div>
												<div class="col-xl-6">
													<div class="form-group">
														<label>Date Of Birth</label> <span class="text-danger">*</span>
														<input type="date" class="form-control form-control-solid form-control-lg" name="b_day" value="<?= isset($_GET['e']) ? $_GET['b_day'] :  $_SESSION['b_day'] ?>" />
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-xl-6">
													<div class="form-group">
														...
														<input type="number" class="form-control form-control-solid form-control-lg" name="mobile" value="<?= isset($_GET['e']) ? $_GET['mobile'] :  $_SESSION['mobile'] ?>" placeholder="Enter mobile number" />
													</div>
												</div>
												<div class="col-xl-6">
													<div class="form-group">
														<label>Landline</label> <span class="text-danger">*</span>
														<input type="number" class="form-control form-control-solid form-control-lg" name="landline" value="<?= isset($_GET['e']) ? $_GET['landline'] :  $_SESSION['landline'] ?>" placeholder="Enter landline number" />
													</div>
												</div>
											</div>
