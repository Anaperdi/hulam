										...
										<div class="d-flex">
											<div class="flex-shrink-0 mr-7">
												<div class="symbol symbol-50 symbol-lg-120 symbol-circle">
													<img alt="Pic" src="/hulam2/assets/keen/company_logo/<?= $lender['company_logo'] ?>" />
												</div>
											</div>
											<div class="flex-grow-1">
												<div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
													...
													<div class="my-lg-0 my-1">
														...
														<?php else : ?>
															<a href="<?= ($_SESSION['eligible'] == 'no') ? 'debtor/update_information.php' : 'debtor/apply_loan.php?id=' . $lender['user_id'] . '&amount=' . $_GET['amount'] . '&month=' . $_GET['month']  ?>" class="btn btn-sm btn-primary font-weight-bolder">Apply Now</a>
														<?php endif; ?>
													</div>
												</div>
